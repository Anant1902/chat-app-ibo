...
UI_TITLE = os.environ.get("UI_TITLE") or "Programme Resource Centre"
...
#     response = await qna(request_json)
...
SHOULD_STREAM = False #True if AZURE_OPENAI_STREAM.lower() == "true" else False
